        ...
        <div class="col-md-5">
            ...
            <form method="post" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                    <label for="name" class="col-md-5 col-form-label text-md-left">氏名
                        <span class="ml-1 samuraimart-require-input-label">
                            <span class="samuraimart-require-input-label-text">
                                必須
                            </span>
                        </span>
                    </label>
                    <div class="col-md-7">
                        <input id="name" type="text"
                            ...
                            value="{{ old('name') }}" require autocomplete="name" autofocus placeholder="侍 太郎">
                        @error('name')
                ...
                <div class="form-group row">
                    <label for="email" class="col-md-5 col-form-label text-md-left">メールアドレス
                        <span class="ml-1 samuraimart-require-input-label">
                            <span class="samuraimart-require-input-label-text">
                                必須
                            </span>
                    ...
                    <div class="col-md-7">
                        <input id="email" type="text"
                            ...
                            name="email" value="{{ old('email') }}" require autocomplete="email"
                ...
                <div class="form-group row">
                    <label for="postal_code" class="col-md-5 col-form-label text-md-left">郵便番号
                        <span class="ml-1 samuraimart-require-input-label">
                            <span class="samuraimart-require-input-label-text">
                                必須
                            </span>
                    ...
                    <div class="col-md-7">
                        <input type="text"
                            ...
                            name="postal_code" require placeholder="150-0043">
                    </div>
                </div>
