        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="{{ route('products.show', $recommend_product) }}">
                    ...
                    <img src="{{ asset($recommend_product->inage) }}" class="img-thumbnail" alt="">
                    @else
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="samuraimart-produc-label mt-2">
                            {{ $recommend_product->name }}<br>
                            <!-- ★表示 -->
                            <label class="star-rating"
                                data-rate={{ round($recommend_product->reviews->avg('score')*2)/2 }}></label>
        ...
        <div class="row">
            ...
            <div class="col-3">
                <a href="{{ route('products.show', $recently_product) }}">
                    ...
                    @else
                    <img src="{{ asset('img/dummy.png') }}" class="img-thumbnail" alt=""></a>
                @endif
                </a>
                <div class="row">
                    <div class="col-12">
